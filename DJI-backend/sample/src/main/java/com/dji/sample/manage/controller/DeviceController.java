...
public class DeviceController {
    ...
    public HttpResultResponse bindDevice(@RequestBody DeviceDTO device, @PathVariable("device_sn") String deviceSn) {
        ...
        log.debug("Received SN: " + device.getDeviceSn());
    ...
    public HttpResultResponse getDevice(@PathVariable("workspace_id") String workspaceId,
        ...
        log.debug("Update DeviceOPT: " + deviceOpt.get() + " " + deviceOpt.isEmpty());
        return deviceOpt.isEmpty() ? HttpResultResponse.error("device not found.") : HttpResultResponse.success(deviceOpt);
    }
